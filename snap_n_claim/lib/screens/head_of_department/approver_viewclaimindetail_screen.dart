...
class ViewClaimInDetail extends StatefulWidget {
  const ViewClaimInDetail(this._width, this._height, this._user,
      {Key? key})
      : super(key: key);
...
//
// class ViewClaimInDetail extends StatefulWidget {
//   const ViewClaimInDetail(this._width, this._height, this._user{super.key});
//
//   final double _width;
//   final double _height;
//   final Employee _user;
...
//
//   @override
//   State<ViewClaimInDetail> createState() => _ViewClaimInDetailState();
// }
//
// class _ViewClaimInDetailState extends State<ViewClaimInDetail> {
//
//   @override
